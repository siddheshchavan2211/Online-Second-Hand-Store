...
<div class="main-header">
	<div class="container">
		<div class="row">
			<div class="col-xs-12 col-sm-12 col-md-3 logo-holder">
				...
				<div class="logo">
					<a href="index.php">
						...
						<h2>Online Second Hand Store</h2>
				...
				<div class="search-area">
					<form name="search" method="post" action="search-result.php">
						<div class="control-group">
							...
							<input style="font-size:1.4rem" class="search-field" placeholder="Search here..." name="product"
								required="required" />

							<button style="font-size:1.4rem" class="search-button" type="submit" name="search"></button>
			...
			<div class="col-xs-12 col-sm-12 col-md-3 animate-dropdown top-cart-row" style="font-size:1.4rem">
							...
							if (!empty($query)) {
								...
								<div class="clearfix cart-total">
									<div class="pull-right">
										...
										<span class="text">Total :</span><span class='price'>Rs.
